                ...
                <div className="lg:col-span-2 p-8 lg:p-12 bg-white dark:bg-card border-t lg:border-t-0 lg:border-l border-border">
                   ...
                   <div className="mt-10 pt-8 border-t border-border">
                      ...
                      <p className="text-sm text-muted-foreground mb-2">
                        <span className="font-bold text-foreground">2 Years Technical Maintenance</span> (Hosting & Security) included.
                      </p>
                      <p className="text-xs text-muted-foreground">
                        Content updates can be done via our easy DIY editor, or paid support.
                      </p>
                  </div>
                </div>
