...
const valuePoints = [
  {
    ...
    description: "Hate writing? Don't worry. We interview you for 15 mins and write professional, sales-focused copy that sounds like you but sells like a pro."
  },
  {
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8">
          {valuePoints.map((point, index) => {
            return (
              ...
              <div 
                  className="group relative bg-background rounded-2xl p-8 shadow-card hover:shadow-elegant transition-all duration-500 hover:-translate-y-2 border border-border/50 overflow-hidden h-full"
              >
