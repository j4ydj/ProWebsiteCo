...
const steps = [
  {
    ...
    description: "Share details about your trade, services, and send us any photos, logos, or branding you already have. The more we know, the better we can tailor your site."
  },
  {
    icon: Palette,
    step: "Step 2", 
    title: "We Create Your Tailored Design",
    description: "Our designers craft a completely unique website that reflects your business personality, showcases your work, and appeals to your local customers."
  },
  {
    icon: Rocket,
    step: "Step 3",
    title: "Your Site Goes Live",
    description: "Within 48 hours, your professional website is live and ready to start bringing in enquiries. We handle all the technical setup and testing."
  }
];
